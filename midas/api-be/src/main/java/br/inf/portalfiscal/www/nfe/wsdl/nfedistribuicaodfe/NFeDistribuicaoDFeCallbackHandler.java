...
public abstract class NFeDistribuicaoDFeCallbackHandler {
	...
	/**
	 * auto generated Axis2 call back method for nfeDistDFeInteresse method override
	 * this method for handling normal response from nfeDistDFeInteresse operation
	 */
	public void receiveResultnfeDistDFeInteresse(
			br.inf.portalfiscal.www.nfe.wsdl.nfedistribuicaodfe.NFeDistribuicaoDFeStub.NfeDistDFeInteresseResponse result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling error
	 * response from nfeDistDFeInteresse operation
	 */
