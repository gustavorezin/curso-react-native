...
@XmlType(name = "TRetEvento", propOrder = { "infEvento", "signature" })
public class TRetEvento {
	 ...
	 * 
	 * @param value allowed object is {@link TRetEvento.InfEvento }
	 * 
	 */
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "tpAmb", "verAplic", "cOrgao", "cStat", "xMotivo", "chCTe", "tpEvento", "xEvento",
			"nSeqEvento", "dhRegEvento", "nProt" })
