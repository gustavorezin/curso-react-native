 ...
 * element interface generated in the br.inf.portalfiscal.nfe.schema.distdfeint
 * package.
 * <p>
 ...
 */
@XmlRegistry
public class ObjectFactory_dist {
	private final static QName _DistDFeInt_QNAME = new QName("http://www.portalfiscal.inf.br/nfe", "distDFeInt");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema
	 * derived classes for package: br.inf.portalfiscal.nfe.schema.distdfeint
	 * 
	 */
	public ObjectFactory_dist() {
	}
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link DistDFeInt
	 * }{@code >}}
	 * 
	 */
	@XmlElementDecl(namespace = "http://www.portalfiscal.inf.br/nfe", name = "distDFeInt")
	public static JAXBElement<DistDFeInt> createDistDFeInt(DistDFeInt value) {
