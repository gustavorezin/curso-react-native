...
public class TRetConsSitMDFe {
    ...
    protected List<TProcEvento_old> procEventoMDFe;
     ...
     * {@link TProcEvento_old }
     * 
     * 
     */
    public List<TProcEvento_old> getProcEventoMDFe() {
        if (procEventoMDFe == null) {
            procEventoMDFe = new ArrayList<TProcEvento_old>();
        }
