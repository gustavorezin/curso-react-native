...
/**
 * NFeRecepcaoEvento4CallbackHandler Callback class, Users can extend this class
...
public abstract class NFeRecepcaoEvento4CallbackHandler {
	...
	/**
	 * auto generated Axis2 call back method for nfeRecepcaoEvento method override
	 * this method for handling normal response from nfeRecepcaoEvento operation
	 */
	public void receiveResultnfeRecepcaoEvento(NFeRecepcaoEvento4Stub.NfeResultMsg result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling error
	 * response from nfeRecepcaoEvento operation
	 */
