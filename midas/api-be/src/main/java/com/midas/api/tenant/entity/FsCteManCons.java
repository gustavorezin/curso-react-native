...
@Entity
@Table(name = "fs_cteman_cons")
public class FsCteManCons implements Serializable {
	...
	public FsCteManCons(Integer id, CdPessoa cdpessoaemp, Date data, Time hora, String ultimonsu) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FsCteManCons other = (FsCteManCons) obj;
