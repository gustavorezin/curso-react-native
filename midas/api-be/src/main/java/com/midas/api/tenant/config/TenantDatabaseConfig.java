...
@ComponentScan(basePackages = { "com.midas.api.tenant.repository", "com.midas.api.tenant.entity" })
@EnableJpaRepositories(basePackages = { "com.midas.api.tenant.repository",
		"com.midas.api.tenant.service" }, entityManagerFactoryRef = "tenantEntityManagerFactory", transactionManagerRef = "tenantTransactionManager")
public class TenantDatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		emfBean.setPackagesToScan("com.midas.api.tenant.*");
		...
		properties.put(Environment.DEFAULT_BATCH_FETCH_SIZE, 30);
