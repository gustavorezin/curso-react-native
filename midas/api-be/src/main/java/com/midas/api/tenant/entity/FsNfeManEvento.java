...
@Entity
@Table(name = "fs_nfeman_evento")
public class FsNfeManEvento implements Serializable {
	...
	public FsNfeManEvento() {
	}

	public FsNfeManEvento(Long id, FsNfeMan fsnfeman, CdPessoa cdpessoaemp, Date dhevento, Date dheventohr,
			String tpevento, Integer nseqevento, String xevento, String chave, String nprot) {
		super();
		this.id = id;
		this.fsnfeman = fsnfeman;
	...
	public FsNfeMan getFsnfeman() {
		return fsnfeman;
	}

	public void setFsnfeman(FsNfeMan fsnfeman) {
		this.fsnfeman = fsnfeman;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FsNfeManEvento other = (FsNfeManEvento) obj;
